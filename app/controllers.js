...
angular.controller('SelectEmployeeController', ['$scope', '$http', 'EmployeesService', '$location' , function($scope, $http, EmployeesService, $location) {
...
angular.controller('NewTimeSheetController', ['$scope', 'EmployeesService', 'UtilitiesService', function($scope, EmployeesService, UtilitiesService) {    
    $scope.selecteds = EmployeesService.List;
...
angular.service('EmployeesService', function() {
  this.List = [];
